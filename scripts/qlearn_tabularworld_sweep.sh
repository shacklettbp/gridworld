...
do
    ...
    do
        let num_steps=100000/$num_worlds
        echo $num_steps
        ...
        do
            ...
            do
                ...
                do
                    MADRONA_MWGPU_KERNEL_CACHE=/tmp/gridworldcache python "$SCRIPT_DIR/q_learning_tabularworld_strategies.py" \
